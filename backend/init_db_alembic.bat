...
echo.
echo [2/3] Creation de la migration initiale...
python scripts\create_migration_alembic.py
if errorlevel 1 (
    echo.
    echo ERREUR lors de la creation de la migration
    pause
    exit /b 1
)
